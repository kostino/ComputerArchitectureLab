...
Συνολικά προκύπτουν παρόμοια αποτελέσματα σε σχέση με τη συνάρτηση κόστους της προηγούμενης εργασίας όσον αφορά το μέγεθος των μνημών καθώς αυτές μεγαλώνουν το area(άρα και το EDAP ) αλλά και κοστίζουν περισσότερο. Μεγάλη διαφορά βλέπουμε όσον αφορά το cache line size που είναι μια φτηνή λύση που αυξάνει αρκετά την απόδοση αλλά κοστίζει πάρα πολύ σε area άρα αυξάνει το EDAP ένω μείωνε τη συνάρτηση κόστους/απόδοσης , ενώ επίσης η αύξηση του  associativity για την L1 data cache ήταν μια επιλογή που κόστιζε αρκετά και δεν βελτίωνε ιδιαίτερα την απόδοση αλλά μικραίνει πολύ το EDAP καθώς μειώνει πολύ και το Area αλλά και την καταναλισκόμενη ενέργεια.  
_Καταλήγουμε λοιπόν πως τα αποτελέσματα μας είναι αρκετά διαφορετικά και πρέπει ως αρχιτέκτονες υπολογιστών να λαμβάνουμε υπ'όψιν διαφορετικά πράγματα ανάλογα με τον στόχο που έχουμε (high energy efficiency για handheld συσκευες ή high performance to cost ratio για desktop computers)._
